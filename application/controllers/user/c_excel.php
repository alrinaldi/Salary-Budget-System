...
Class C_excel extends CI_Controller{
 ...
 // Set Merge Cell pada kolom A1 sampai E1
		...
		a.workcenter as wct,a.dept,a.seksi,b.rupiah as rp,a.gol as gol,(CASE WHEN a.gol = '1' then a.budget WHEN a.gol = '2' THEN a.budget WHEN a.gol = '3' THEN a.budget WHEN a.gol = '4' then a.budget when a.gol = 'Kontrak' then a.budget else 0 end) as budget
		 ...
		 a.gol in('1','2','3','4','0') and a.bulan = 'JANUARY' GROUP by a.workcenter,a.gol,a.bulan 
		 ...
		 a.workcenter as wct,a.dept,a.seksi,b.rupiah as rp,a.gol as gol,(CASE WHEN a.gol = '1' then a.budget WHEN a.gol = '2' THEN a.budget WHEN a.gol = '3' THEN a.budget WHEN a.gol = '4' then a.budget when a.gol = 'Kontrak' then a.budget else 0 end) as budget
		 from overtime a join asumsi_overtime b on a.gol = b.gol join master_overtime c on a.workcenter = c.workcenter where
		a.gol in('1','2','3','4','0') and a.bulan = 'FEBRUARY' and c.bulan = 'FEBRUARY' GROUP by a.workcenter,a.gol,a.bulan 
		ORDER by a.workcenter");
		...
		a.workcenter as wct,a.dept,a.seksi,b.rupiah as rp,a.gol as gol,(CASE WHEN a.gol = '1' then a.budget WHEN a.gol = '2' THEN a.budget WHEN a.gol = '3' THEN a.budget WHEN a.gol = '4' then a.budget when a.gol = 'Kontrak' then a.budget else 0 end) as budget
 		from overtime a join asumsi_overtime b on a.gol = b.gol join master_overtime c on a.workcenter = c.workcenter where
 		 a.gol in('1','2','3','4','0') and a.bulan = 'MARCH' and c.bulan = 'MARCH' GROUP by a.workcenter,a.gol,a.bulan 
		  ORDER by a.workcenter");
		...
		a.workcenter as wct,a.dept,a.seksi,b.rupiah as rp,a.gol as gol,(CASE WHEN a.gol = '1' then a.budget WHEN a.gol = '2' THEN a.budget WHEN a.gol = '3' THEN a.budget WHEN a.gol = '4' then a.budget when a.gol = 'Kontrak' then a.budget else 0 end) as budget
		 from overtime a join asumsi_overtime b on a.gol = b.gol join master_overtime c on a.workcenter = c.workcenter where
		  a.gol in('1','2','3','4','0') and a.bulan = 'APRIL' and c.bulan = 'APRIL' GROUP by a.workcenter,a.gol,a.bulan 
		  ORDER by a.workcenter");
		...
		a.workcenter as wct,a.dept,a.seksi,b.rupiah as rp,a.gol as gol,(CASE WHEN a.gol = '1' then a.budget WHEN a.gol = '2' THEN a.budget WHEN a.gol = '3' THEN a.budget WHEN a.gol = '4' then a.budget when a.gol = 'Kontrak' then a.budget else 0 end) as budget
		 from overtime a join asumsi_overtime b on a.gol = b.gol join master_overtime c on a.workcenter = c.workcenter where
		  a.gol in('1','2','3','4','0') and a.bulan = 'MAY' and c.bulan = 'MAY' GROUP by a.workcenter,a.gol,a.bulan 
		  ORDER by a.workcenter");
		...
		a.workcenter as wct,a.dept,a.seksi,b.rupiah as rp,a.gol as gol,(CASE WHEN a.gol = '1' then a.budget WHEN a.gol = '2' THEN a.budget WHEN a.gol = '3' THEN a.budget WHEN a.gol = '4' then a.budget when a.gol = 'Kontrak' then a.budget else 0 end) as budget
		 from overtime a join asumsi_overtime b on a.gol = b.gol join master_overtime c on a.workcenter = c.workcenter where
		  a.gol in('1','2','3','4','0') and a.bulan = 'JUNE' and c.bulan = 'JUNE' GROUP by a.workcenter,a.gol,a.bulan 
		  ORDER by a.workcenter");
		...
		a.workcenter as wct,a.dept,a.seksi,b.rupiah as rp,a.gol as gol,(CASE WHEN a.gol = '1' then a.budget WHEN a.gol = '2' THEN a.budget WHEN a.gol = '3' THEN a.budget WHEN a.gol = '4' then a.budget when a.gol = 'Kontrak' then a.budget else 0 end) as budget
		 from overtime a join asumsi_overtime b on a.gol = b.gol join master_overtime c on a.workcenter = c.workcenter where
		  a.gol in('1','2','3','4','0') and a.bulan = 'JULY' and c.bulan = 'JULY' GROUP by a.workcenter,a.gol,a.bulan 
		  ORDER by a.workcenter");
		...
		a.workcenter as wct,a.dept,a.seksi,b.rupiah as rp,a.gol as gol,(CASE WHEN a.gol = '1' then a.budget WHEN a.gol = '2' THEN a.budget WHEN a.gol = '3' THEN a.budget WHEN a.gol = '4' then a.budget when a.gol = 'Kontrak' then a.budget else 0 end) as budget
		 from overtime a join asumsi_overtime b on a.gol = b.gol join master_overtime c on a.workcenter = c.workcenter where
		  a.gol in('1','2','3','4','0') and a.bulan = 'AUGUST' and c.bulan = 'AUGUST' GROUP by a.workcenter,a.gol,a.bulan 
		  ORDER by a.workcenter");
		...
		a.workcenter as wct,a.dept,a.seksi,b.rupiah as rp,a.gol as gol,(CASE WHEN a.gol = '1' then a.budget WHEN a.gol = '2' THEN a.budget WHEN a.gol = '3' THEN a.budget WHEN a.gol = '4' then a.budget when a.gol = 'Kontrak' then a.budget else 0 end) as budget
		 from overtime a join asumsi_overtime b on a.gol = b.gol join master_overtime c on a.workcenter = c.workcenter where
		  a.gol in('1','2','3','4','0') and a.bulan = 'SEPTEMBER' and c.bulan = 'SEPTEMBER' GROUP by a.workcenter,a.gol,a.bulan 
		  ORDER by a.workcenter");
		...
		a.workcenter as wct,a.dept,a.seksi,b.rupiah as rp,a.gol as gol,(CASE WHEN a.gol = '1' then a.budget WHEN a.gol = '2' THEN a.budget WHEN a.gol = '3' THEN a.budget WHEN a.gol = '4' then a.budget when a.gol = 'Kontrak' then a.budget else 0 end) as budget
		 from overtime a join asumsi_overtime b on a.gol = b.gol join master_overtime c on a.workcenter = c.workcenter where
		  a.gol in('1','2','3','4','0') and a.bulan = 'OCTOBER' and c.bulan = 'OCTOBER' GROUP by a.workcenter,a.gol,a.bulan 
		  ORDER by a.workcenter");
		...
		a.workcenter as wct,a.dept,a.seksi,b.rupiah as rp,a.gol as gol,(CASE WHEN a.gol = '1' then a.budget WHEN a.gol = '2' THEN a.budget WHEN a.gol = '3' THEN a.budget WHEN a.gol = '4' then a.budget when a.gol = 'Kontrak' then a.budget else 0 end) as budget
		 from overtime a join asumsi_overtime b on a.gol = b.gol join master_overtime c on a.workcenter = c.workcenter where
		  a.gol in('1','2','3','4','0') and a.bulan = 'NOVEMBER' and c.bulan = 'NOVEMBER' GROUP by a.workcenter,a.gol,a.bulan 
		  ORDER by a.workcenter");
		...
		a.workcenter as wct,a.dept,a.seksi,b.rupiah as rp,a.gol as gol,(CASE WHEN a.gol = '1' then a.budget WHEN a.gol = '2' THEN a.budget WHEN a.gol = '3' THEN a.budget WHEN a.gol = '4' then a.budget when a.gol = 'Kontrak' then a.budget else 0 end) as budget
		 from overtime a join asumsi_overtime b on a.gol = b.gol join master_overtime c on a.workcenter = c.workcenter where
		  a.gol in('1','2','3','4','0') and a.bulan = 'DECEMBER' and c.bulan = 'DECEMBER' GROUP by a.workcenter,a.gol,a.bulan 
		  ORDER by a.workcenter");

		  $ovtcc = $ovtdec->num_rows();

		$tovtjan = $this->db->query("SELECT sum(jam) as quantity, sum(budget) as budget from overtime where tahun = '$year' and bulan = 'January'  ");
		$tovtfeb = $this->db->query("SELECT sum(jam) as quantity, sum(budget) as budget from overtime where tahun = '$year' and bulan = 'February'  ");
		$tovtmar = $this->db->query("SELECT sum(jam) as quantity, sum(budget) as budget from overtime where tahun = '$year' and bulan = 'March'  ");
		$tovtapr = $this->db->query("SELECT sum(jam) as quantity, sum(budget) as budget from overtime where tahun = '$year' and bulan = 'April'  ");
		$tovtme = $this->db->query("SELECT sum(jam) as quantity, sum(budget) as budget from overtime where tahun = '$year' and bulan = 'Mei'  ");
		$tovtjun = $this->db->query("SELECT sum(jam) as quantity, sum(budget) as budget from overtime where tahun = '$year' and bulan = 'June'  ");
		$tovtjul = $this->db->query("SELECT sum(jam) as quantity, sum(budget) as budget from overtime where tahun = '$year' and bulan = 'July'  ");
		$tovtaug = $this->db->query("SELECT sum(jam) as quantity, sum(budget) as budget from overtime where tahun = '$year' and bulan = 'August'  ");
		$tovtsep = $this->db->query("SELECT sum(jam) as quantity, sum(budget) as budget from overtime where tahun = '$year' and bulan = 'September'  ");
		$tovtokt = $this->db->query("SELECT sum(jam) as quantity, sum(budget) as budget from overtime where tahun = '$year' and bulan = 'October'  ");
		$tovtnov = $this->db->query("SELECT sum(jam) as quantity, sum(budget) as budget from overtime where tahun = '$year' and bulan = 'November'  ");
		$tovtdec = $this->db->query("SELECT sum(jam) as quantity, sum(budget) as budget from overtime where tahun = '$year' and bulan = 'December'  ");
		...
		foreach($ovtfeb->result() as $data){ // Lakukan looping pada variabel siswa
		  ...
		  foreach($tovtjan->result() as $data){ // Lakukan looping pada variabel siswa
			$excel->setActiveSheetIndex(0)->setCellValue('E'.$nm1, 'TOTAL');
			$excel->setActiveSheetIndex(0)->setCellValue('F'.$nm1, $data->quantity);
			$excel->setActiveSheetIndex(0)->setCellValue('G'.$nm1, $data->budget);
  
			// Apply style row yang telah kita buat tadi ke masing-masing baris (isi tabel)
			$excel->getActiveSheet()->getStyle('E'.$nm1)->applyFromArray($style_row);
			$excel->getActiveSheet()->getStyle('F'.$nm1)->applyFromArray($style_row);
			$excel->getActiveSheet()->getStyle('G'.$nm1)->applyFromArray($style_row);
  
			$no++; // Tambah 1 setiap kali looping
			$nm1++; // Tambah 1 setiap kali looping
		  }
		  foreach($tovtfeb->result() as $data){ // Lakukan looping pada variabel siswa
  
			  $excel->setActiveSheetIndex(0)->setCellValue('H'.$nm2, $data->quantity);
			  $excel->setActiveSheetIndex(0)->setCellValue('I'.$nm2, $data->budget);
	
			  // Apply style row yang telah kita buat tadi ke masing-masing baris (isi tabel)
  
			  $excel->getActiveSheet()->getStyle('H'.$nm2)->applyFromArray($style_row);
			  $excel->getActiveSheet()->getStyle('I'.$nm2)->applyFromArray($style_row);
	
			  $no++; // Tambah 1 setiap kali looping
			  $nm2++; // Tambah 1 setiap kali looping
			}
  
			foreach($tovtmar->result() as $data){ // Lakukan looping pada variabel siswa
  
			  $excel->setActiveSheetIndex(0)->setCellValue('J'.$nm3, $data->quantity);
			  $excel->setActiveSheetIndex(0)->setCellValue('K'.$nm3, $data->budget);
	
			  // Apply style row yang telah kita buat tadi ke masing-masing baris (isi tabel)
  
			  $excel->getActiveSheet()->getStyle('J'.$nm3)->applyFromArray($style_row);
			  $excel->getActiveSheet()->getStyle('K'.$nm3)->applyFromArray($style_row);
	
			  $no++; // Tambah 1 setiap kali looping
			  $nm3++; // Tambah 1 setiap kali looping
			}
  
			foreach($tovtapr->result() as $data){ // Lakukan looping pada variabel siswa
  
			  $excel->setActiveSheetIndex(0)->setCellValue('L'.$nm4, $data->quantity);
			  $excel->setActiveSheetIndex(0)->setCellValue('M'.$nm4, $data->budget);
	
			  // Apply style row yang telah kita buat tadi ke masing-masing baris (isi tabel)
  
			  $excel->getActiveSheet()->getStyle('L'.$nm4)->applyFromArray($style_row);
			  $excel->getActiveSheet()->getStyle('M'.$nm4)->applyFromArray($style_row);
	
			  $no++; // Tambah 1 setiap kali looping
			  $nm3++; // Tambah 1 setiap kali looping
			}
  
			foreach($tovtme->result() as $data){ // Lakukan looping pada variabel siswa
  
			  $excel->setActiveSheetIndex(0)->setCellValue('N'.$nm5, $data->quantity);
			  $excel->setActiveSheetIndex(0)->setCellValue('O'.$nm5, $data->budget);
	
			  // Apply style row yang telah kita buat tadi ke masing-masing baris (isi tabel)
  
			  $excel->getActiveSheet()->getStyle('N'.$nm5)->applyFromArray($style_row);
			  $excel->getActiveSheet()->getStyle('O'.$nm5)->applyFromArray($style_row);
	
			  $no++; // Tambah 1 setiap kali looping
			  $nm5++; // Tambah 1 setiap kali looping
			}
  
			foreach($tovtjun->result() as $data){ // Lakukan looping pada variabel siswa
  
			  $excel->setActiveSheetIndex(0)->setCellValue('P'.$nm6, $data->quantity);
			  $excel->setActiveSheetIndex(0)->setCellValue('Q'.$nm6, $data->budget);
	
			  // Apply style row yang telah kita buat tadi ke masing-masing baris (isi tabel)
  
			  $excel->getActiveSheet()->getStyle('P'.$nm6)->applyFromArray($style_row);
			  $excel->getActiveSheet()->getStyle('Q'.$nm6)->applyFromArray($style_row);
	
			  $no++; // Tambah 1 setiap kali looping
			  $nm6++; // Tambah 1 setiap kali looping
			}
  
			foreach($tovtjul->result() as $data){ // Lakukan looping pada variabel siswa
  
			  $excel->setActiveSheetIndex(0)->setCellValue('R'.$nm7, $data->quantity);
			  $excel->setActiveSheetIndex(0)->setCellValue('S'.$nm7, $data->budget);
	
			  // Apply style row yang telah kita buat tadi ke masing-masing baris (isi tabel)
  
			  $excel->getActiveSheet()->getStyle('R'.$nm7)->applyFromArray($style_row);
			  $excel->getActiveSheet()->getStyle('S'.$nm7)->applyFromArray($style_row);
	
			  $no++; // Tambah 1 setiap kali looping
			  $nm7++; // Tambah 1 setiap kali looping
			}
  
			foreach($tovtaug->result() as $data){ // Lakukan looping pada variabel siswa
  
			  $excel->setActiveSheetIndex(0)->setCellValue('T'.$nm8, $data->quantity);
			  $excel->setActiveSheetIndex(0)->setCellValue('U'.$nm8, $data->budget);
	
			  // Apply style row yang telah kita buat tadi ke masing-masing baris (isi tabel)
  
			  $excel->getActiveSheet()->getStyle('T'.$nm8)->applyFromArray($style_row);
			  $excel->getActiveSheet()->getStyle('U'.$nm8)->applyFromArray($style_row);
	
			  $no++; // Tambah 1 setiap kali looping
			  $nm8++; // Tambah 1 setiap kali looping
			}
  
			foreach($tovtsep->result() as $data){ // Lakukan looping pada variabel siswa
  
			  $excel->setActiveSheetIndex(0)->setCellValue('V'.$nm9, $data->quantity);
			  $excel->setActiveSheetIndex(0)->setCellValue('W'.$nm9, $data->budget);
	
			  // Apply style row yang telah kita buat tadi ke masing-masing baris (isi tabel)
  
			  $excel->getActiveSheet()->getStyle('V'.$nm9)->applyFromArray($style_row);
			  $excel->getActiveSheet()->getStyle('W'.$nm9)->applyFromArray($style_row);
	
			  $no++; // Tambah 1 setiap kali looping
			  $nm9++; // Tambah 1 setiap kali looping
			}
  
			foreach($tovtokt->result() as $data){ // Lakukan looping pada variabel siswa
  
			  $excel->setActiveSheetIndex(0)->setCellValue('X'.$nm10, $data->quantity);
			  $excel->setActiveSheetIndex(0)->setCellValue('Y'.$nm10, $data->budget);
	
			  // Apply style row yang telah kita buat tadi ke masing-masing baris (isi tabel)
  
			  $excel->getActiveSheet()->getStyle('X'.$nm10)->applyFromArray($style_row);
			  $excel->getActiveSheet()->getStyle('Y'.$nm10)->applyFromArray($style_row);
	
			  $no++; // Tambah 1 setiap kali looping
			  $nm10++; // Tambah 1 setiap kali looping
			}
  
			foreach($tovtnov->result() as $data){ // Lakukan looping pada variabel siswa
  
			  $excel->setActiveSheetIndex(0)->setCellValue('Z'.$nm11, $data->quantity);
			  $excel->setActiveSheetIndex(0)->setCellValue('AA'.$nm11, $data->budget);
	
			  // Apply style row yang telah kita buat tadi ke masing-masing baris (isi tabel)
  
			  $excel->getActiveSheet()->getStyle('Z'.$nm11)->applyFromArray($style_row);
			  $excel->getActiveSheet()->getStyle('AA'.$nm11)->applyFromArray($style_row);
	
			  $no++; // Tambah 1 setiap kali looping
			  $nm11++; // Tambah 1 setiap kali looping
			}
  
			foreach($tovtdec->result() as $data){ // Lakukan looping pada variabel siswa
  
			  $excel->setActiveSheetIndex(0)->setCellValue('AB'.$nm12, $data->quantity);
			  $excel->setActiveSheetIndex(0)->setCellValue('AC'.$nm12, $data->budget);
	
			  // Apply style row yang telah kita buat tadi ke masing-masing baris (isi tabel)
  
			  $excel->getActiveSheet()->getStyle('AB'.$nm12)->applyFromArray($style_row);
			  $excel->getActiveSheet()->getStyle('AC'.$nm12)->applyFromArray($style_row);
	
			  $no++; // Tambah 1 setiap kali looping
			  $nm12++; // Tambah 1 setiap kali looping
			}
	...
	// }
	  ...
	  function export_salary_bln(){
		...
		$month = $this->input->post('bulan');
		$hslc = $this->db->query("SELECT a.workcenter,a.dept,a.seksi,a.gol,b.costAllocation,sum(a.gp) as gp, sum(a.incentive) as incentive, 
		...
		$excel->setActiveSheetIndex(0)->setCellValue('P5', "Tunj. Rumah"); // Set kolom D3 dengan tulisan "JENIS KELAMIN"
		$excel->setActiveSheetIndex(0)->setCellValue('Q5', "Tunj. Cuti Besar"); // Set kolom D3 dengan tulisan "JENIS KELAMIN"
		$excel->setActiveSheetIndex(0)->setCellValue('R5', "Donation1 "); // Set kolom E3 dengan tulisan "ALAMAT"
		$excel->setActiveSheetIndex(0)->setCellValue('S5', "Telekomunikasi"); // Set kolom D3 dengan tulisan "JENIS KELAMIN"
		$excel->setActiveSheetIndex(0)->setCellValue('T5', "Tunj. Function Allow "); // Set kolom E3 dengan tulisan "ALAMAT"
		$excel->setActiveSheetIndex(0)->setCellValue('U5', "THR"); // Set kolom D3 dengan tulisan "JENIS KELAMIN"
		$excel->setActiveSheetIndex(0)->setCellValue('V5', "BONUS"); // Set kolom E3 dengan tulisan "ALAMAT"
		$excel->setActiveSheetIndex(0)->setCellValue('W5', "JAMSOSTEK"); // Set kolom D3 dengan tulisan "JENIS KELAMIN"
		$excel->setActiveSheetIndex(0)->setCellValue('X5', "DPA  & BPJS PENSIUN"); // Set kolom E3 dengan tulisan "ALAMAT"
		$excel->setActiveSheetIndex(0)->setCellValue('Y5', " Tunj. Pajak (Reguler)"); // Set kolom B3 dengan tulisan "NIS"
		$excel->setActiveSheetIndex(0)->setCellValue('Z5', "TOTAL"); // Set kolom C3 dengan tulisan "NAMA"
		...
		$grandovt = $this->db->query("SELECT sum(a.budget) as budget,(CASE WHEN b.costAllocation <> 'OPEX' then 'COGS' else 'OPEX' end)
		as govtgrp from overtime a join costcenter b on a.workcenter = b.costcenter where a.tahun = '$year' and a.bulan = '$month' group by govtgrp ");
		
		foreach($grandovt->result() as $grovt):
			$grbgt[] = $grovt->budget;
		endforeach;
		...
		$ovtall = $this->db->query("SELECT sum(budget) as budget from overtime where tahun = '$year' and bulan = '$month' group by tahun");
		foreach($ovtall->result() as $ov):
			$lmbrt[] = $ov->budget;
		endforeach;
		...
		$totgt[0] = $totgts[0]+$lmbrt[0];
		$totg[0] = $totgc[0]+$grbgt[0];
		$totg[1] = $totgc[1]+$grbgt[1];
...
$selisih;
		...
		foreach($hsl->result() as $data){ // Lakukan looping pada variabel siswa
			...
			$ovth = $this->db->query("SELECT sum(budget) as budget from overtime where workcenter = '$data->workcenter' and gol = '$data->gol'
			and tahun = '$year' and bulan = '$month'");
			$ovthc = $ovth->num_rows();
			
			foreach($ovth->result() as $dt):
			 $dt->budget;
			
				$toths = (int)$data->total + (int)$dt->budget; 
		  $excel->setActiveSheetIndex(0)->setCellValue('A'.$numrow, $data->workcenter);
		  $excel->setActiveSheetIndex(0)->setCellValue('B'.$numrow, $data->dept);
		  $excel->setActiveSheetIndex(0)->setCellValue('C'.$numrow, $data->seksi);
		  ...
		  $excel->setActiveSheetIndex(0)->setCellValue('I'.$numrow, $dt->budget);
		  ...
		  $excel->setActiveSheetIndex(0)->setCellValue('P'.$numrow, $data->housing_allowance);
		  $excel->setActiveSheetIndex(0)->setCellValue('Q'.$numrow, $data->holiday_allowance);
		  $excel->setActiveSheetIndex(0)->setCellValue('R'.$numrow, $data->donation);
		  $excel->setActiveSheetIndex(0)->setCellValue('S'.$numrow, $data->telecomunication);
		  $excel->setActiveSheetIndex(0)->setCellValue('T'.$numrow, $data->function_allowance);
		  $excel->setActiveSheetIndex(0)->setCellValue('U'.$numrow, $data->thr);
		  $excel->setActiveSheetIndex(0)->setCellValue('V'.$numrow, $data->bonus);
		  $excel->setActiveSheetIndex(0)->setCellValue('W'.$numrow, $data->man_power);
		  $excel->setActiveSheetIndex(0)->setCellValue('X'.$numrow, $data->pension);
		  $excel->setActiveSheetIndex(0)->setCellValue('Y'.$numrow, $data->income_tax);
		  $excel->setActiveSheetIndex(0)->setCellValue('Z'.$numrow, $toths);
		...
		for($selisih;$selisih<$counthsl;$selisih++){
			$excel->setActiveSheetIndex(0)->setCellValue('E'.$selisih, $gpca[$lop]);
			$excel->setActiveSheetIndex(0)->setCellValue('F'.$selisih, $mp[$lop]);
			$excel->setActiveSheetIndex(0)->setCellValue('G'.$selisih, $gpc[$lop]);
			$excel->setActiveSheetIndex(0)->setCellValue('H'.$selisih, $tnjug[$lop]);
			$excel->setActiveSheetIndex(0)->setCellValue('I'.$selisih, $grbgt[$lop]);
			$excel->setActiveSheetIndex(0)->setCellValue('J'.$selisih, $mkng[$lop]);
			$excel->setActiveSheetIndex(0)->setCellValue('K'.$selisih, $tsptg[$lop]);
			$excel->setActiveSheetIndex(0)->setCellValue('L'.$selisih, $obtg[$lop]);
			$excel->setActiveSheetIndex(0)->setCellValue('M'.$selisih, $obpjsg[$lop]);
			$excel->setActiveSheetIndex(0)->setCellValue('N'.$selisih, $rs1g[$lop]);
			$excel->setActiveSheetIndex(0)->setCellValue('O'.$selisih, $rs2g[$lop]);
			$excel->setActiveSheetIndex(0)->setCellValue('P'.$selisih, $rmg[$lop]);
			$excel->setActiveSheetIndex(0)->setCellValue('Q'.$selisih, $ctg[$lop]);
			$excel->setActiveSheetIndex(0)->setCellValue('R'.$selisih, $dtg[$lop]);
			$excel->setActiveSheetIndex(0)->setCellValue('S'.$selisih, $tlg[$lop]);
			$excel->setActiveSheetIndex(0)->setCellValue('T'.$selisih, $fcg[$lop]);
			$excel->setActiveSheetIndex(0)->setCellValue('U'.$selisih, $thrg[$lop]);
			$excel->setActiveSheetIndex(0)->setCellValue('V'.$selisih, $bong[$lop]);
			$excel->setActiveSheetIndex(0)->setCellValue('W'.$selisih, $mpig[$lop]);
			$excel->setActiveSheetIndex(0)->setCellValue('X'.$selisih, $psg[$lop]);
			$excel->setActiveSheetIndex(0)->setCellValue('Y'.$selisih, $phg[$lop]);
			$excel->setActiveSheetIndex(0)->setCellValue('Z'.$selisih, $totg[$lop]);
	  ...
	  $excel->getActiveSheet()->getStyle('E'.$selisih)->applyFromArray($style_row);
		...
		$excel->getActiveSheet()->getStyle('Y'.$selisih)->applyFromArray($style_row);
		$excel->getActiveSheet()->getStyle('Z'.$selisih)->applyFromArray($style_row);
	 $lop++;
 
		}
		for($sg;$sg<$gcounthsl;$sg++){
			$excel->setActiveSheetIndex(0)->setCellValue('E'.$sg, $tt);
			$excel->setActiveSheetIndex(0)->setCellValue('F'.$sg, $mpt[$lopt]);
			$excel->setActiveSheetIndex(0)->setCellValue('G'.$sg, $gpct[$lopt]);
			$excel->setActiveSheetIndex(0)->setCellValue('H'.$sg, $tnjugt[$lopt]);
			$excel->setActiveSheetIndex(0)->setCellValue('I'.$sg, $lmbrt[$lopt]);
			$excel->setActiveSheetIndex(0)->setCellValue('J'.$sg, $mkngt[$lopt]);
			$excel->setActiveSheetIndex(0)->setCellValue('K'.$sg, $tsptgt[$lopt]);
			$excel->setActiveSheetIndex(0)->setCellValue('L'.$sg, $obtgt[$lopt]);
			$excel->setActiveSheetIndex(0)->setCellValue('M'.$sg, $obpjsgt[$lopt]);
			$excel->setActiveSheetIndex(0)->setCellValue('N'.$sg, $rs1gt[$lopt]);
			$excel->setActiveSheetIndex(0)->setCellValue('O'.$sg, $rs2gt[$lopt]);
			$excel->setActiveSheetIndex(0)->setCellValue('P'.$sg, $rmgt[$lopt]);
			$excel->setActiveSheetIndex(0)->setCellValue('Q'.$sg, $ctgt[$lopt]);
			$excel->setActiveSheetIndex(0)->setCellValue('R'.$sg, $dtgt[$lopt]);
			$excel->setActiveSheetIndex(0)->setCellValue('S'.$sg, $tlgt[$lopt]);
			$excel->setActiveSheetIndex(0)->setCellValue('T'.$sg, $fcgt[$lopt]);
			$excel->setActiveSheetIndex(0)->setCellValue('U'.$sg, $thrgt[$lopt]);
			$excel->setActiveSheetIndex(0)->setCellValue('V'.$sg, $bongt[$lopt]);
			$excel->setActiveSheetIndex(0)->setCellValue('W'.$sg, $mpigt[$lopt]);
			$excel->setActiveSheetIndex(0)->setCellValue('X'.$sg, $psgt[$lopt]);
			$excel->setActiveSheetIndex(0)->setCellValue('Y'.$sg, $phgt[$lopt]);
			$excel->setActiveSheetIndex(0)->setCellValue('Z'.$sg, $totgt[$lopt]);
	  ...
	  $excel->getActiveSheet()->getStyle('E'.$sg)->applyFromArray($style_row);
		...
		$excel->getActiveSheet()->getStyle('Y'.$sg)->applyFromArray($style_row);
		$excel->getActiveSheet()->getStyle('Z'.$sg)->applyFromArray($style_row);
	 $lop++;
		...
		$this->session->set_flashdata('error_dt','Data tidak ditemukan ');
		redirect('user/c_salary/list_salary_bln');
	}
	  }
	  ...
	  function export_salary_thn(){
		...
		$grandovt = $this->db->query("SELECT sum(a.budget) as budget,(CASE WHEN b.costAllocation <> 'OPEX' then 'COGS' else 'OPEX' end)
		as govtgrp from overtime a join costcenter b on a.workcenter = b.costcenter where a.tahun = '$year' group by govtgrp ");
		...
		$ovtall = $this->db->query("SELECT sum(budget) as budget from overtime where tahun = '$year' group by tahun");
		foreach($ovtall->result() as $ov):
			$lmbrt[] = $ov->budget;
		endforeach;
...
$selisih;
	 ...
	 $lop++;
		...
		$this->session->set_flashdata('error_dt','Data tidak ditemukan');
		redirect('user/c_salary/list_salary_thn');
	}
	}
