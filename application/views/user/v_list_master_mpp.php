	...
	<script type= 'text/javascript'>
		$(document).ready(function () {
			$('#dataTable').DataTable({
				"processing": true,
				"serverSide": true,
				"ajax": "<?php echo base_url('user/c_mpp/get_mpp')?>"
			});
			...
			$(document).delegate('.edit', 'click', function() {
				...
				buttons.html("<button id='save'>Save</button>  <button class='delete' id='" + id_master_mpp.html() + "'>Delete</button>");
			});
...
?><div class="form-group">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
						<p> <a href="#add" class="btn" rel="modal:open">Add new Data</a> </p>	
