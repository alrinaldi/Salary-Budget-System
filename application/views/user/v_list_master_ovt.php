	...
	<script type= 'text/javascript'>
		$(document).ready(function () {
			$('#dataTable').DataTable({
				"processing": true,
				"serverSide": true,
				"ajax": "<?php echo base_url('user/c_overtime/get_ovt')?>"
			});
			...
			$(document).delegate('#save', 'click', function() {
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url('user/c_overtime/update_overtime')?>",
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Master Overtime</h1>
		  <p class="mb-4"></p>
		  ...
		  <div class="row">
			<div class="col-xs-6 col-md-4">
                ...
                <div class="card-body">
				<form action="<?php echo base_url().'user/c_overtime/list_master_ovt'?>" method='post'>
<?php
...
?><div class="form-group">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h3 class="m-0 font-weight-bold text-primary">Overtime <?php echo $this->session->userdata('thnplh1'); ?></h3>
			</div>
